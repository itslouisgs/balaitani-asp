<%@ Page Title="" Language="C#" MasterPageFile="~/View/Template.Master" AutoEventWireup="true" CodeBehind="AboutUsPage.aspx.cs" Inherits="balaitani_psd.View.AboutUsPage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="d-flex align-items-center flex-column container py-5">
        <img class="logo py-3" src="/Asset/logo-black.png" alt="BalaiTani">
        <div class="details d-flex p-3">
            ...
            <div class="px-4">
                <p class="h5" style="text-align: justify">
                    <b>BalaiTani</b> is an application that connects
